...
public class ToDoClient {
	...
	public ToDo add(ToDo toDo) {
		UriComponents uriComponents = UriComponentsBuilder.newInstance().uri(URI.create(this.props.getHost()))
				.path(this.props.getPath()).build();
		ResponseEntity<ToDo> response = this.restTemplate.exchange(RequestEntity.post(uriComponents.toUri()).body(toDo),
	...
	public ToDo findById(String id) {
		UriComponents uriComponents = UriComponentsBuilder.newInstance().uri(URI.create(this.props.getHost()))
				.pathSegment(this.props.getPath(), "/{id}").buildAndExpand(id);
	...
	public Collection<ToDo> findAll() {
		UriComponents uriComponents = UriComponentsBuilder.newInstance().uri(URI.create(this.props.getHost())).build();
		Traverson traverson = new Traverson(uriComponents.toUri(), MediaTypes.HAL_JSON,
